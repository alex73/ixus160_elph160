...
// let's try... look for shuttersoundtask
// FF99A728
static long *nrflag = (long*)(0x75F4);
...
/*************************************************************/
//** sub_FF99A7E8_my @ 0xFF99A7E8 - 0xFF99AA58, length=157
...
/*************************************************************/
//** sub_FFAD80B0_my @ 0xFFAD80B0 - 0xFFAD8474, length=242
void __attribute__((naked,noinline)) sub_FFAD80B0_my() {
asm volatile (
"    STMFD   SP!, {R4-R11,LR} \n"
"    SUB     SP, SP, #0x1C \n"
"    MOV     R6, R0 \n"
...
"    TST     R0, #1 \n"
"    LDRNE   R2, =0x11A \n"
"    LDRNE   R1, =0xFFAD8498 /*'SsGISCaptureSeq.c'*/ \n"
"    MOVNE   R0, #0 \n"
"    BLNE    _DebugAssert \n"
"    LDR     R0, [SP, #8] \n"
"    AND     R0, R0, #0xFF00 \n"
...
"    BL      sub_FF99B344 \n"
"    LDR     R2, =0x3A98 \n"
"    LDR     R3, =0xFFAD8498 /*'SsGISCaptureSeq.c'*/ \n"
"    MOV     R1, #4 \n"
"    STR     R11, [SP] \n"
"    BL      sub_FF89237C \n"
"    CMP     R0, #0 \n"
...
/*************************************************************/
//** sub_FF999FC4_my @ 0xFF999FC4 - 0xFF99A038, length=30
void __attribute__((naked,noinline)) sub_FF999FC4_my() {
asm volatile (
"    STMFD   SP!, {R0-R7,LR} \n"
"    SUB     SP, SP, #0x1C \n"
"    MOV     R4, R0 \n"
...
"    LDRNE   R2, =0xFF99A2C8 \n"
"    LDREQ   R2, =0xFF99A23C \n"
// "Test for bit value in a table, don't know what it is"
"    CMP     R0, #0 \n"
"    BEQ     loc_FFAD7DA0 \n"
"    CMP     R0, #1 \n"
"    BEQ     loc_FFAD7DC4 \n"
...
/*************************************************************/
//** sub_FF999E38_my @ 0xFF999E38 - 0xFF999EC0, length=35
void __attribute__((naked,noinline)) sub_FF999E38_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    MOV     R8, R1 \n"
"    LDR     R1, =0x1CD88 \n"
...
/*************************************************************/
//** sub_FF999EC4_my @ 0xFF999EC4 - 0xFF999F58, length=38
void __attribute__((naked,noinline)) sub_FF999EC4_my() {
asm volatile (
"    STMFD   SP!, {R4-R8,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x11C] \n"
...
/*************************************************************/
//** sub_FF999F5C_my @ 0xFF999F5C - 0xFF999FC0, length=26
void __attribute__((naked,noinline)) sub_FF999F5C_my() {
asm volatile (
"    STMFD   SP!, {R4-R7,LR} \n"
"    MOV     R4, R0 \n"
"    LDR     R0, [R0, #0x11C] \n"
...
/*************************************************************/
//** sub_FF999DE4_my @ 0xFF999DE4 - 0xFF999E2C, length=19
void __attribute__((naked,noinline)) sub_FF999DE4_my() {
asm volatile (
"    STMFD   SP!, {R3-R5,LR} \n"
"    LDR     R4, =0x1CF78 \n"
"    LDR     R0, =0x1CD88 \n"
...
"    TST     R0, #1 \n"
"    MOVNE   R2, #0x348 \n"
"    LDRNE   R1, =0xFF99A044 /*'SsCaptureCommon.c'*/ \n"
"    MOVNE   R0, #0 \n"
"    BLNE    _DebugAssert \n"
"    LDRSH   R0, [R4, #0xC] \n"
"    LDRSH   R1, [SP] \n"
