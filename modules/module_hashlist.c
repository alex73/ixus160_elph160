...
extern void force_usb_state(void);
extern void gui_enum_value_change(void);
extern void shooting_get_hyperfocal_distance(void);
extern void draw_ellipse(void);
extern void TurnOffBackLight(void);
extern void draw_txt_string(void);
extern void shooting_get_resolution(void);
extern void shooting_update_dof_values(void);
extern void raw_closefile(void);
extern void ptp_script_create_msg(void);
extern void shooting_set_iso_mode(void);
extern void shooting_set_iso_real(void);
extern int libhisto;
extern int librawop;
extern void fgets(void);
...
extern void get_tick_count(void);
extern void shooting_get_tv96_from_shutter_speed(void);
extern int zoom_points;
...
extern void draw_filled_round_rect(void);
...
extern void vid_get_viewport_height(void);
extern int libscriptapi;
extern void get_raw_pixel(void);
extern void shutdown(void);
extern void draw_filled_ellipse(void);
extern int altGuiHandler;
extern void draw_rect(void);
extern void draw_line(void);
extern void draw_char(void);
extern void action_push_func(void);
...
extern void isxdigit(void);
extern void shooting_set_user_av_by_id(void);
...
extern void shooting_set_user_tv_by_id_rel(void);
extern void fclose(void);
extern void fflush(void);
extern int libmpopup;
...
extern void kbd_get_clicked_key(void);
extern int libdng;
extern void module_save_edge(void);
extern void shooting_set_zoom_rel(void);
extern void SetFileAttributes(void);
extern void get_battery_temp(void);
...
extern void shooting_get_iso_mode(void);
extern void shooting_get_display_mode(void);
extern void levent_index_for_name(void);
extern void PostLogicalEventForNotPowerType(void);
extern void shooting_set_user_av_by_id_rel(void);
extern void shooting_get_iso_market(void);
extern void raw_createfile(void);
extern void lang_str(void);
...
extern void get_usb_power(void);
extern void shot_histogram_isenabled(void);
extern void shooting_get_user_tv_id(void);
extern void shooting_get_user_av_id(void);
extern int libmotiondetect;
extern void strrchr(void);
extern void strpbrk(void);
extern void shooting_iso_market_to_real(void);
...
extern void camera_set_led(void);
extern int camera_sensor;
extern void script_colors(void);
extern void shooting_set_tv96_direct(void);
extern void rbf_draw_string_len(void);
extern void console_clear(void);
extern void toupper(void);
extern void tolower(void);
extern void shooting_set_av96(void);
extern void shooting_set_zoom(void);
extern void shooting_set_prop(void);
extern void shooting_set_tv96(void);
extern void shooting_set_sv96(void);
extern void levent_index_for_id(void);
extern void lens_get_zoom_point(void);
extern void get_raw_image_addr(void);
extern void get_effective_focal_length(void);
...
extern void shooting_set_user_av96(void);
extern void shooting_set_user_tv96(void);
extern void shooting_mode_chdk2canon(void);
...
extern void get_exposure_counter(void);
extern void shooting_can_focus(void);
extern void patch_bad_pixel(void);
extern void kbd_key_press(void);
extern void get_parameter_size(void);
...
extern void rbf_font_height(void);
extern void module_restore_edge(void);
extern int module_colors;
extern void shot_histogram_set(void);
extern void action_push_release(void);
extern void config_restore(void);
extern void shooting_get_tv96(void);
extern void shooting_get_zoom(void);
extern void shooting_get_prop(void);
extern void shooting_get_bv96(void);
extern void shooting_get_av96(void);
extern void swap_partitions(void);
extern void shooting_set_user_tv_by_id(void);
extern void vid_get_bitmap_active_palette(void);
extern void is_video_recording(void);
extern void gui_default_kbd_process_menu_btn(void);
extern void UnlockAE(void);
extern void UnlockAF(void);
extern void UnlockMF(void);
extern void shooting_get_ev_correction1(void);
extern void script_end(void);
extern void get_batt_perc(void);
extern void rbf_draw_string(void);
extern void rbf_draw_symbol(void);
extern void GetRawCount(void);
extern void vid_get_viewport_width(void);
extern void isspace(void);
extern void isupper(void);
...
extern void shot_histogram_get_range(void);
extern void raw_prepare_develop(void);
extern void __mulsf3(void);
extern void __muldf3(void);
extern void debug_led(void);
extern void start_usb_HPtimer(void);
extern void action_top(void);
extern void localtime(void);
extern void live_histogram_read_y(void);
...
extern void rbf_str_width(void);
extern void shooting_set_focus(void);
extern void save_config_file(void);
extern void draw_txt_char(void);
extern void draw_rect_shadow(void);
extern void module_preload(void);
extern void remotecap_get_target_support(void);
extern void play_sound(void);
extern void shooting_get_shutter_speed_from_tv96(void);
extern void rbf_draw_menu_header(void);
extern void gui_draw_osd_elements(void);
extern void remotecap_set_target(void);
extern void gui_set_mode(void);
extern void draw_filled_rect_thick(void);
...
extern void shooting_iso_real_to_market(void);
extern void rbf_draw_clipped_string(void);
extern void script_print_screen_statement(void);
extern void TurnOffDisplay(void);
extern void stat_get_vbatt(void);
extern void console_add_line(void);
extern void strftime(void);
extern void strerror(void);
extern void draw_filled_rect(void);
...
{ 0x9d04b09a, vid_get_bitmap_active_palette },
{ 0x9d14ea63, is_video_recording },
